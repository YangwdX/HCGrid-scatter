...
def setup_header(mapcenter, mapsize, beamsize_fwhm):
    ...
    pixsize = beamsize_fwhm / 3.  # =2*beam_size/3600./3 =beam_size / 5400
    dnaxis1 = int(mapsize[0] / pixsize) #=mapsize/(beamsize/5400) 
